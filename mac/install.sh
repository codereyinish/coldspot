...
echo ""
echo "${GRN}${BLD}  ✓ ColdSpot installed!${RST}"
echo ""
echo "  • Exit server   → ${SERVER_IP}:${EXIT_PORT}"
echo "  • Exit config   → $CONF"
echo "  • Menu-bar ❄️ toggle turns ColdSpot on/off."
echo ""
echo "  To use it: make sure the iPhone app is running, connect this Mac to the"
echo "  iPhone's hotspot, then flip ❄️ ON. After a reboot it stays off until you"
echo "  turn it on."
echo ""
